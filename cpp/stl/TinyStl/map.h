...
namespace mystl
{
    //模板类 Map,key value不可重复
    //1.key的类型 2.实值类型 3.键值的比较方式
    ...
    class map{
        ...
        class value_compare:public binary_function<value_type,value_type,bool>
        {
            ...
            public:
                bool operator()(const value_type& lhs,const value_type& rhs) const{
                    return comp(lhs.first,rhs.first);//比较key的大小
                }
        };
        ...
        private:
            ...
            base_type tree_;
        public:
            typedef typename base_type::node_type node_type;//node_ptr,也就是有value的那个
            ...
            typedef typename base_type::const_reverse_iterator const_reverse_iteraotr;
            ...
            mapped_type& at(const key_type& key){
                ...
                THROW_OUT_OF_RANGE_IF(it==end()||key_comp()(it->first,key),"not exist");
                return it->second;
            }
