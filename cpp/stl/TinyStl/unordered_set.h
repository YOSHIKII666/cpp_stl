...
namespace mystl
{
    ...
    public:
        ...
        typedef typename base_type::size_type  difference_type;
        typedef typename base_type::size_type  pointer;
        typedef typename base_type::size_type  const_pointer;
        typedef typename base_type::size_type  reference;
        typedef typename base_type::size_type  const_reference;
    ...
    public:
        ...
        unordered_set(InputIterator first,InputIterator last,
                        ...
                        const KeyEqual& equal =KeyEqual()):ht_(mystl::max(bucket_count,static_cast<size_type>(mystl::distance(first,last)),hash,equal)) {
